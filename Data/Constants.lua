...
---@class Constants
GL.Data.Constants = {
    defaultFrameTitle = string.format(L.GARGUL_NAME, GL.version),
    ...
    ItemQualityColors = {
        ...
        [1] = {
            description = L.LANG_ITEM_COMMON,
            rgb255 = "255,255,255",
            RGB255 = { 255, 255, 255 },
            rgb = "1.00,1.00,1.00",
            RGB = { 1.00, 1.00, 1.00 },
        ...
        [2] = {
            description = L.LANG_ITEM_UNCOMMON,
            rgb255 = "30,255,0",
            RGB255 = { 30, 255, 0 },
            rgb = "0.12,1.00,0.00",
            RGB = { 0.12, 1.00, 0.00 },
        ...
        [5] = {
            description = L.LANG_ITEM_LEGENDARY,
            rgb255 = "255,128,0",
            RGB255 = { 255, 128, 0 },
            rgb = "1.00,0.50,0.00",
            RGB = { 1.00, 0.50, 0.00 },
        ...
        [6] = {
            description = L.LANG_ITEM_ARTIFACT,
            rgb255 = "230,204,128",
            RGB255 = { 230, 204, 128 },
            rgb = "0.90,0.80,0.50",
            RGB = { 0.90, 0.80, 0.50 },
        ...
        [7] = {
            description = L.LANG_ITEM_HEIRLOOM,
            rgb255 = "0,204,255",
            RGB255 = { 0, 204, 255 },
            rgb = "0.00,0.8,1.0",
            RGB = { 0.00, 0.8, 1.0 },
        ...
        [8] = {
            description = L.LANG_ITEM_WOWTOKEN ,
            rgb255 = "0,204,255",
            RGB255 = { 0, 204, 255 },
            rgb = "0.00,0.8,1.0",
            RGB = { 0.00, 0.8, 1.0 },
    ...
    DroppedLoot = {
        WhenToLogLoot = {
            [1] = L.LANG_DROPPED_LOOT1,
            [2] = L.LANG_DROPPED_LOOT2,
            [3] = L.LANG_DROPPED_LOOT3,
            [4] = L.LANG_DROPPED_LOOT4,
            [5] = L.LANG_DROPPED_LOOT5,
        }
    },
    ...
    Races = {
        human = L.LANG_RACES1,
        dwarf = L.LANG_RACES2,
        nightelf = L.LANG_RACES3,
        gnome = L.LANG_RACES4,
        draenei = L.LANG_RACES5,
        worgen = L.LANG_RACES6,
        orc = L.LANG_RACES7,
        scourge = L.LANG_RACES8,
        tauren = L.LANG_RACES9,
        troll = L.LANG_RACES10,
        bloodelf = L.LANG_RACES11,
        goblin = L.LANG_RACES12,
        pandaren = L.LANG_RACES13,
        dracthyr = L.LANG_RACES14,
    },
