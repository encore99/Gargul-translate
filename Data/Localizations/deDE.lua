...
--MINIMAP (MM)
--[[
    Hier sind die übersetzungen als variablen für minimap.lua 
    Here are translations for minimap.lua
]]
L.OPEN_GARGUL_MM = "|cffffffffClick:|r Gargul Öffnen";
L.IMPORT_DATA_MM = "|cffffffffRight-click:|r Daten Importieren";
L.SOFTRES_MM = "|cffffffffShift+click:|r SoftRes";
L.EXPORT_DATA_MM = "|cffffffffShift+Right-click:|r Daten Exportieren";
L.SLASH_COMMAND_MM = "|cffffffffSlash Kommando:|r /gl or /gargul";