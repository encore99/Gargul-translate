...
GL.Data.DefaultSettings = {
    ...
    MasterLooting = {
        ...
        announceMasterLooterMessage = L.LANG_ANNOUNCE_MASTERLOOT_MSG,
    ...
    RollTracking = {
        ...
        trackAll = false,
        Brackets = {
            {L.LANG_ROLL_MS, 1, 100, 2, false, false},
            {L.LANG_ROLL_OS, 1, 99, 3, true, false},
        },
    },
    SoftRes = {
    ...
    GDKP = {
        ...
        finalCallTime = 10,
        potExportFormat = 1,
        customExportHeader = L.LANG_CUSTOM_EXPORT_HEADER,
        customExportFormat = L.LANG_CUSTOM_EXPORT_FORMAT,
        customPotExportHeader = L.LANG_CUSTOM_POT_EXPORT_HEADER,
        customPotExportFormat = L.LANG_CUSTOM_POT_EXPORT_FORMAT,
        ...
        queuedAuctionNoBidsAction = L.LANG_QUED_AUCTION_NOBIDACTION,
        showBidWindow = true,
