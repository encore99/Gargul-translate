...
function BonusFeatures:build()
    ...
    --[[ GROUP MANAGER ]]
    ---@type FontString
    local GroupManagerLabel = Interface:createFontString(Window, L.GROUP_MANAGER_1);
    ...
    --[[ BOOSTED ROLLS ]]
    ---@type FontString
    local BoostedRollsLabel = Interface:createFontString(Window, L.BOOSTED_ROLLS_1);
    ...
    --[[ PLUS ONES ]]
    ---@type FontString
    local PlusOnesLabel = Interface:createFontString(Window, L.PLUSONES_1);
