...
function PlayerSelector:draw(description, PlayerNames, callback)
    ...
    Description:SetText(L.LABEL_TEXT3 .. description);
    ...
    PlayerNameLabel:SetText(L.LABEL_TEXT2);
    ...
    PlayerNameLabelSuffix:SetText(L.LABEL_TEXT1);
    ...
    ConfirmButton:SetText(L.CONFIRM_BTN_GARGUL);
